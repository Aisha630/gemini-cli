...
export const TableRenderer: React.FC<TableRendererProps> = ({
  ...
  // Here, raw, pre-markdown text is used. Since InlineRenderer will remove markdown symbols, this could lead to slightly different heights than expected. But this does not matter much since the amount of symbols is usually small compared to the overall text length and | will be rendered correctly to enclose the table anyway.
